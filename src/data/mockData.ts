...
export const mockProperties: Property[] = [
  ...
  { id: '6', name: 'Casa 2Hab con A/C | cerca Pirámide', role: 'cohost', type: 'casa', imageUrl: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?auto=format&fit=crop&w=800&q=80', gallery: [], location: 'Paseos del Bosque, Corregidora, Querétaro, México', hostName: 'Ricardo Peña C. (Co-anfitrión)', hostPhone: '4421851478', hostEmail: 'ricardo@example.com', cleaningFee: 400, commissionRate: 15, maintenanceFee: 250, pricePerNight: 1800, bedrooms: 2, bathrooms: 1, maxGuests: 2, sqft: 120, parking: true, pool: false, petFriendly: false, airbnbUrl: 'airbnb.mx/rooms/1667036785999383762', airbnbId: '1667036785999383762', status: 'activo' },
